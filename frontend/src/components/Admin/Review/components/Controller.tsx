...
const ReviewDataController: React.FC<Props> = ({
  selectedCount,
  table,
  handleRefreshData,
  handleDeleteReview,
      ...
      <div className="flex items-center gap-2">
        {selectedCount > 0 && isSuperAdmin && (
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem onClick={() => handleDeleteReview()} className="text-red-600 focus:text-red-600">
...
export default ReviewDataController
