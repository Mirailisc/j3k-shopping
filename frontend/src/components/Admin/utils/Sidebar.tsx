  ...
  return (
    <div className="fixed left-0 top-[60px] bottom-[10px]">
      <AnimatePresence mode="wait">
        <motion.div
          className="p-2 border h-[calc(100vh-90px)] border-black/20 dark:border-white/10 bg-zinc-100 dark:bg-zinc-900 m-[10px] mt-[20px] rounded-sm"
        ...
        >
          <Link
            ...
            className={`p-2 rounded-sm transition-colors flex items-center ${sidebar?.isSidebarOpen ? 'justify-start' : 'justify-center'} gap-2 hover:bg-zinc-200 dark:hover:bg-zinc-800`}
          >
            <CircleGauge size={16} />
